...
CSV_PATH = '../storage/crypto/BINANCE/tables/current/analysis/price_average/price_average_1m/dprice/dprice_average_1m/ddprice.csv'
RAW_PATH = '../storage/crypto/BINANCE/tables/current/analysis/price_average/price_average_1m/dprice/dprice_average_1m.csv'
...
def update(symbols):
    ...
    Misc.printDebug('ddPrice1m.update(): FINISHED')
