...
NAME = str(TIME) + UNIT
CSV_PATH = '../storage/crypto/BINANCE/tables/current/analysis/price_average/price_average_4h/dprice/dprice_average_30m/ddprice/ddprice_average_' + NAME + '.csv'
RAW_PATH = '../storage/crypto/BINANCE/tables/current/analysis/price_average/price_average_4h/dprice/dprice_average_30m/ddprice.csv'
