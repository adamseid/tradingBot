...
CSV_PATH = '../storage/crypto/BINANCE/tables/current/analysis/price_average/price_average_4h/dprice/dprice_average_1m/ddprice.csv'
RAW_PATH = '../storage/crypto/BINANCE/tables/current/analysis/price_average/price_average_4h/dprice/dprice_average_1m.csv'
